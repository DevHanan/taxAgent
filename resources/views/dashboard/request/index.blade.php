                    ...
                    <div class="row">
                        <div class="col-md-12" id="ajax">
                            <table id="datatable" class="text-center table table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                @foreach($requests as $key => $order)
                                    <tr>
                                        <td>{{++$key}}</td>
                                        <td><a href="{{url('/admin/clients/'.$order->client['id'].'/edit')}}">{{$order->client['name']}}</a></td>
                                        <td><a href="{{url('/admin/products/'.$order->product->id.'/edit')}}">{{$order->product->title}}</a></td>
                                                        ...
                                                        <div class="m-dropdown__body">
                                                            <div class="m-dropdown__content">
                                                                <ul class="m-nav">
                                                                    ...
                                                                    @can('delete requests')
                                                                        <li class="m-nav__item">
                                                                            <form action="{{route('requests.destroy',$order->id)}}" class="m-nav__link  lh"  method="post">
                                                                                @csrf @method('DELETE')
