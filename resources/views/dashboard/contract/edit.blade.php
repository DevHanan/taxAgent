...
@section('path')
    ...
    <li class="m-nav__item">
        <a href="{{url('admin/contracts/'.$contract->id.'/edit')}}" class="m-nav__link">
        ...
        <div class="row">
                            ...
                            <div class="m-portlet m-portlet--tab">
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group row mb-25">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control m-input" type="text" placeholder="عنوان العقد " id="example-text-input" name="title_ar"  value="{{$contract->getTranslation('title','ar')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row mb-25">
                                        ...
                                        <div class="col-9">
                                            <textarea class="summernote form-control m-input" id="m_summernote_1" name="body_ar">{!! $contract->getTranslation('body','ar') !!}</textarea>
                                         </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="m-portlet m-portlet--tab">
                                <div class="m-portlet__body text-right">
                                    ...
                                    <div class="form-group m-form__group row mb-25">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control m-input" type="text" placeholder="contract title" id="example-text-input" name="title_en"  value="{{$contract->getTranslation('title','en')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-form__group row mb-25">
                                        ...
                                        <div class="col-9">
                                            <textarea class="summernote form-control m-input" id="m_summernote_1" name="body_en">{!! $contract->getTranslation('body','en') !!}</textarea>
                                        </div>
                                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="m-portlet m-portlet--tab mb-25">
                    ...
                    <div class="m-portlet__body">
                        <img src="{{asset('storage/'.$contract->image->name)}}" alt="" class="img-fluid" height="250px">
