                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                <a href="{{url('/admin/videos/create')}}" class="btn btn-success" {{--data-toggle="modal" data-target="#m_modal_6"--}}><i class="fa fa-plus pr-2"></i>اضافة ألبوم</a>
                            </h3>
                        </div>
                    </div>
                </div>
                            ...
                            <table id="datatable" class="text-center table table-bordered" cellspacing="0" width="100%">
                                ...
                                @foreach($videos as $key => $video)
                                    <tr>
                                        ...
                                        <td>{{$video->getTranslation('title','en')}}</td>
                                        <td><a  href="{{url('/admin/playlists/'.$video->playlist->id.'/edit')}}">{{$video->playlist->title}}</a></td>
                                                        ...
                                                        <div class="m-dropdown__body">
                                                            <div class="m-dropdown__content">
                                                                <ul class="m-nav">
                                                                    ...
                                                                    @can('edit videos')
                                                                        <li class="m-nav__item">
                                                                            <a href="{{url('admin/videos/'.$video->id.'/edit ')}}" class="m-nav__link  lh">
                                                                    ...
                                                                    @can('delete videos')
                                                                        <li class="m-nav__item">
                                                                            <form action="{{route('videos.destroy',$video->id)}}" class="m-nav__link  lh"  method="post">
                                                                                @csrf @method('DELETE')
         ...
         <div class="modal-dialog modal-dialog-centered" role="document">
             <div class="modal-content">
                 <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLongTitle">اضف ألبوم</h5>
                 ...
                 <div class="modal-body">
                     <div class="form-group m-form__group mb-25">
                         <label for="exampleInputPassword1">الفيديو :</label>
                         <input type="password" class="form-control m-input" id="exampleInputPassword1" placeholder="الفيديو">
                     </div>
                 </div>
