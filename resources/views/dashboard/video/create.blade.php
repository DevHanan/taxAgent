...
فيديو جديد
    ...
    @section('path')
        ...
        <li class="m-nav__separator">-</li>
        <li class="m-nav__item">
            <a href="{{url('admin/videos/create')}}" class="m-nav__link">
                                ...
                                <div class="m-portlet m-portlet--tab">
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="form-group m-form__group row mb-25">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control m-input" type="text" placeholder="عنوان الفيديو" id="example-text-input" name="title_ar">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row mb-25">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control m-input" type="url" placeholder="رابط الفيديو" id="example-text-input" name="url">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row mb-25">
                                            ...
                                            <div class="col-9">
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="وصف الفيديو" name="body_ar"></textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="m-portlet m-portlet--tab">
                                    <div class="m-portlet__body text-right">
                                        ...
                                        <div class="form-group m-form__group row mb-25">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control m-input" type="text" placeholder="video title" id="example-text-input" name="title_en">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row mb-25">
                                            ...
                                            <div class="col-9">
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="Video details" name="body_en"></textarea>
                                            </div>
                                        </div>
