...
@section('path')
    <li class="m-nav__item">
        <a href="{{url('admin/categories')}}" class="m-nav__link">
            <span class="m-nav__link-text">التصنيفات</span>
        </a>
    </li>
    <li class="m-nav__separator">-</li>
    <li class="m-nav__item">
        <a href="{{url('admin/categories/'.$category->id.'/edit')}}" class="m-nav__link">
                            ...
                            <div class="m-portlet m-portlet--tab">
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group row mb-25">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control m-input" type="text" placeholder="عنوان الألبوم" id="example-text-input" name="title_ar" value="{{$category->getTranslation('title','ar')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="m-portlet m-portlet--tab">
                                <div class="m-portlet__body text-right">
                                    ...
                                    <div class="form-group m-form__group row mb-25">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control m-input" type="text" placeholder="album title" id="example-text-input" name="title_en" value="{{$category->getTranslation('title','en')}}">
                                        </div>
                                    </div>
