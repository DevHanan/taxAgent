...
@endpush
    ...
    @section('path')
        ...
        <li class="m-nav__item">
            <a href="{{url('admin/services/create')}}" class="m-nav__link">
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
                            ...
                            <div class="m-portlet__head-tools">
                                <ul class="nav nav-tabs m-tabs m-tabs-line   m-tabs-line--left m-tabs-line--primary" role="tablist">
                                    <li class="nav-item m-tabs__item">
                                        <a class="nav-link m-tabs__link active" data-toggle="tab" href="#m_services_profile_tab_1" role="tab">
                                            <i class="flaticon-share m--hide"></i>
                                                اللغة العربية
                                        </a>
                                    </li>
                                    <li class="nav-item m-tabs__item">
                                        <a class="nav-link m-tabs__link" data-toggle="tab" href="#m_services_profile_tab_2" role="tab">
                                              اللغة الإنجليزية
                                        </a>
                                    </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="m_services_profile_tab_1">
                                <div class="m-portlet m-portlet--tab">
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="form-group m-form__group row mb-25">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control m-input" type="text" placeholder="عنوان الخدمة " id="example-text-input" name="title_ar"  value="{{old('title_ar')}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row mb-25">
                                            ...
                                            <div class="col-9">
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="تفاصيل الخدمة" name="body_ar"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane " id="m_services_profile_tab_2"  style="direction: ltr;">
                                <div class="m-portlet m-portlet--tab">
                                    <div class="m-portlet__body text-right">
                                        <!--begin::Section-->
                                        <div class="form-group m-form__group row mb-25">
                                            <label for="example-text-input" class="col-3 col-form-label">services title</label>
                                            <div class="col-9">
                                                <input class="form-control m-input" type="text" placeholder="services title" id="example-text-input" name="title_en"  value="{{old('title_en')}}">
                                            </div>
                                        </div>

                                        <div class="form-group m-form__group row mb-25">
                                            <label for="exampleFormControlTextarea1" class="col-3 col-form-label">services details</label>
                                            <div class="col-9">
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="5"    placeholder="services details" name="body_en" ></textarea>
                                            </div>
                                        </div>
