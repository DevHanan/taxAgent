                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                <a href="{{url('/admin/services/create')}}" class="btn btn-success" {{--data-toggle="modal" data-target="#m_modal_6"--}}><i class="fa fa-plus pr-2"></i>اضافة خدمة</a>
                            </h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12" id="ajax">
                            <table id="datatable" class="text-center table table-bordered" cellspacing="0" width="100%">
                                ...
                                @foreach($services as $key => $service)
                                    <tr>
                                        <td>{{++$key}}</td>
                                        <td><img src="{{asset('storage/'.$service->image->name)}}" alt="service image" height="60px"></td>
                                        <td>{{$service->getTranslation('title','ar')}}</td>
                                        <td>{{$service->getTranslation('title','en')}}</td>
                                        <td><a href="{{url('admin/pdf/'.$service->contract->id)}}" target="_blank">{{$service->contract->title}}</a></td>
                                                        ...
                                                        <div class="m-dropdown__body">
                                                            <div class="m-dropdown__content">
                                                                <ul class="m-nav">
                                                                    @can('edit services')
                                                                        <li class="m-nav__item">
                                                                            <a href="{{url('admin/services/'.$service->id.'/edit ')}}" class="m-nav__link  lh">
                                                                    ...
                                                                    @can('delete services')
                                                                        <li class="m-nav__item">
                                                                            <form action="{{route('services.destroy',$service->id)}}" class="m-nav__link  lh"  method="post">
                                                                                @csrf @method('DELETE')
         ...
         <div class="modal-dialog modal-dialog-centered" role="document">
             <div class="modal-content">
                 <div class="modal-header">
                     <h5 class="modal-title" id="exampleModalLongTitle">اضف خدمة</h5>
                 ...
                 <div class="modal-body">
                     <div class="form-group m-form__group mb-25">
                         ...
                         <input type="password" class="form-control m-input" id="exampleInputPassword1" placeholder="الخدمة">
                     </div>
                 </div>
